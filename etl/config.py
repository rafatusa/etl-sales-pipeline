...
class Config:
    ...
    s3_input_prefix: str = field(default_factory=lambda: os.environ.get("S3_INPUT_PREFIX", "input/"))
    s3_processed_prefix: str = field(default_factory=lambda: os.environ.get("S3_PROCESSED_PREFIX", "processed/"))
    s3_failed_prefix: str = field(default_factory=lambda: os.environ.get("S3_FAILED_PREFIX", "failed/"))
    ...
    db_name: str = field(default_factory=lambda: os.environ.get("DB_NAME", "salesdb"))
    ...
    db_ssl_mode: str = field(default_factory=lambda: os.environ.get("DB_SSL_MODE", "require"))
    ...
    retry_delay_seconds: int = field(default_factory=lambda: int(os.environ.get("RETRY_DELAY_SECONDS", "5")))
